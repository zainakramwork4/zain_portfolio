  ...
  return (
    <section className="py-20 w-full">
      <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full">
       ...
       {/* GitHub Streak Card - Custom Vercel Deployment */}
<ItemLayout className={"col-span-full md:col-span-6 p-0!"}>
  <img
    className="w-full h-auto object-contain min-h-37.5"
    src={`https://github-readme-streak-stats-nu-kohl.vercel.app?user=zainakramwork4&theme=dark&hide_border=true&type=svg&background=EB545400&ring=FEFE5B&currStreakLabel=FEFE5B&v=${Date.now()}`}
    alt="GitHub Streak"
    loading="eager"
  />
</ItemLayout>
